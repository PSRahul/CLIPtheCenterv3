    ...
    def forward(self, image_path, output_roi, split):
        ...
        for batch_index in range(batch_size):
            ...
            output_roi_index = output_roi[
                batch_index
                * self.cfg["evaluation"]["topk_k"] : batch_index
            ...
            for detection_index in range(self.cfg["evaluation"]["topk_k"]):
                ...
                image_clip_embedding = self.clip_model.encode_image(
                    image_cropped_clip.cuda()
                )

                clip_encodings[
                    batch_index * self.cfg["evaluation"]["topk_k"] + detection_index, :
